...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO machines (name, machine_type, price_per_play, status) 
              VALUES ('$name', '$type', $price, '$status')";
    
    if($db->exec($query)) {
        $message = '<div class="alert alert-success">Machine added successfully!</div>';
    } else {
        $message = '<div class="alert alert-danger">Error adding machine!</div>';
    }
}
?>
...
<head>
    ...
    <title>Add Machine - PlayMeter</title>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <form method="POST">
                ...
                <div class="mb-3">
                    <label for="price" class="form-label">Price per Play (KSh)</label>
                ...
                <a href="machines.php" class="btn btn-secondary">Cancel</a>
            </form>
        </div>
    </div>
</body>
